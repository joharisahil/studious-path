...
// import { addFee, getClassFees } from '@/services/FeesApi';
...
//   // ✅ Auto-fill fee based on selected student's grade
//   useEffect(() => {
//     if (selectedStudentData?.grade && classFees[selectedStudentData.grade]) {
//       form.setValue('totalFee', classFees[selectedStudentData.grade].toString());
//     }
//   }, [selectedStudentData, classFees, form]);

//   // ✅ Submit to real API
//   const onSubmit = async (data: AddFeeFormData) => {
//     setIsLoading(true);
//     try {
//       await addFee(data); // Call backend
...
//                   <FormLabel>Description (Optional)</FormLabel>
//                   <FormControl>
//                     <Input placeholder="e.g., Tuition Fee, Activity Fee, etc." {...field} />
//                   </FormControl>
//                   <FormMessage />
//                 </FormItem>
//               )}
